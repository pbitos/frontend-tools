$("#switch").on("click", () => {
	if ($("#switch").prop("checked")) {
		$("body").addClass("dark");
		$(".switch-text").addClass("darkspan");
		$("p").addClass("text-display-dark");
		$(".card").addClass("darkcard");
		$(".card-main").addClass("dark-card-main");
	} else {
		$("body").removeClass("dark");
		$(".switch-text").removeClass("darkspan");
		$("p").removeClass("text-display-dark");
		$(".card").removeClass("darkcard");
		$(".card-main").removeClass("dark-card-main");
	}
})
...
body.onkeydown = function (e) {
	...
	document.querySelector('.key-display').innerHTML = e.key;
